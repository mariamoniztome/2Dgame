...
export class Zone1Scene extends Phaser.Scene {
  ...
  _buildDecorations() {
    ...
    const CAMPO_POS = [
      // row 0 — top fringe: alternating tall trees and small ground flowers
      [ 50,  45, 440],[220,  30, 130],[440,  55, 380],[660,  38, 160],[880,  58, 460],[1090, 42, 120],[1230, 72, 350],
      // row 1 — upper mid: medium shrubs mixed with a big tree
      [ 70, 195, 180],[290, 180, 420],[510, 205, 140],[730, 192, 390],[950, 210, 170],[1170,198, 440],
      // row 2 — centre: large specimens and small accent plants
      [ 55, 360, 460],[270, 348, 150],[490, 375, 320],[710, 358, 480],[930, 378, 130],[1148,362, 370],
      // row 3 — lower mid: varying as a thicket
      [ 80, 525, 140],[298, 510, 400],[520, 538, 190],[738, 522, 450],[958, 542, 160],[1178,528, 330],
      // row 4 — bottom fringe: large canopy trees at edges, small plants centre
      [ 62, 662, 420],[280, 648, 150],[498, 672, 460],[718, 655, 130],[938, 668, 380],[1158,655, 170],
    ];
    ...
    const TRANS_POS = [
      [ 70, 760, 380],[260, 748, 130],[480, 772, 290],[700, 752, 420],[920, 778, 150],[1148,758, 340],
      [ 80, 898, 160],[298, 882, 410],[518, 908, 120],[738, 892, 360],[958, 918, 190],[1178,898, 440],
      [ 65,1048, 430],[285,1032, 140],[505,1058, 370],[725,1038, 120],[945,1062, 410],[1165,1042,160],
      [ 80,1188, 150],[298,1172, 380],[518,1198, 120],[738,1178, 440],[958,1202, 170],[1178,1182,350],
      [ 70,1338, 400],[288,1322, 140],[508,1348, 460],[728,1328, 120],[948,1352, 310],[1168,1332,180],
    ];
    ...
    const LIMIAR_POS = [
      [ 80,1478, 350],[298,1462, 120],[518,1488, 420],[738,1468, 150],[958,1492, 390],[1178,1472,130],
      [ 70,1618, 130],[288,1602, 430],[508,1628, 160],[728,1608, 390],[948,1632, 120],[1168,1612,450],
      [ 80,1758, 460],[298,1742, 140],[518,1768, 310],[738,1748, 460],[958,1772, 130],[1178,1752,400],
      [ 70,1898, 150],[288,1882, 420],[508,1908, 120],[728,1888, 380],[948,1912, 170],[1168,1892,440],
      [ 80,2038, 410],[298,2022, 130],[518,2048, 460],[738,2028, 150],[958,2052, 350],[1178,2032,120],
    ];
